...
public class CommentaryId implements Identifier<Long> {
    private final UUID value;

    public CommentaryId(UUID value) {
    ...
    private Notification validate(UUID value) {
        ...
        if (value == null) {
            notification.addError("Commentary ID must not be null.");
        }
        return notification;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CommentaryId that)) return false;
